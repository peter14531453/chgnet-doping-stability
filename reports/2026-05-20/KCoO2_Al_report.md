...
This study investigates whether **Al** (the *dopant*) can be stably inserted into the crystal structure of **KCoO2** (the *host material*) by replacing one of the **Co** atoms already present in the crystal. This process is called *doping*.
...
An MSD slope this close to zero (0.00047 Å²/ps) means the dopant was essentially locked in place — it barely moved at all during the simulation. The farthest the dopant moved from its starting position was **1.33 Å** (about 2.5 times the Bohr radius), with a final mean-squared displacement of **0.298 Å²**.

| Metric | Value | Threshold | Result |
|--------|-------|-----------|--------|
| MSD slope | **0.00047 Å²/ps** | < 0.005 Å²/ps | ✅ PASS |
| Max displacement | **1.328 Å** | reference only | — |
| Final MSD | **0.2980 Å²** | reference only | — |

**Local bonding environment during MD:**

The number of neighboring oxygen atoms fluctuated between **4 and 5** (average: 4.1) during heating, compared to 5 after relaxation. This small variation is normal thermal fluctuation — the dopant's local environment is essentially intact. The average dopant–oxygen bond length during the simulation was **1.788 Å**.

| Metric | Value | Threshold | Result |
|--------|-------|-----------|--------|
| Coordination range | **4–5** (mean 4.1) | within ±1 of 5 | ✅ PASS |
| Avg bond length (MD) | **1.788 Å** | reference only | — |
...
**Al is a strong candidate for the Co site.** All four stability tests passed: the formation energy is thermodynamically favorable, the dopant does not migrate at 250°C, its local atomic environment is preserved during heating, and the host crystal does not expand or contract excessively. This result supports further experimental investigation.
...
*Host: KCoO2 | Dopant: Al | Temperature: 250°C | Sites tested: 1*