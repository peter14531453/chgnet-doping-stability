...
This study investigates whether **Al** (the *dopant*) can be stably inserted into the crystal structure of **NaCoO2** (the *host material*) by replacing one of the **Co** atoms already present in the crystal. This process is called *doping*.
...
An MSD slope this close to zero (0.00082 Å²/ps) means the dopant was essentially locked in place — it barely moved at all during the simulation. The farthest the dopant moved from its starting position was **2.21 Å** (about 4.2 times the Bohr radius), with a final mean-squared displacement of **3.105 Å²**.

| Metric | Value | Threshold | Result |
|--------|-------|-----------|--------|
| MSD slope | **0.00082 Å²/ps** | < 0.005 Å²/ps | ✅ PASS |
| Max displacement | **2.212 Å** | reference only | — |
| Final MSD | **3.1054 Å²** | reference only | — |

**Local bonding environment during MD:**

The number of neighboring oxygen atoms fluctuated between **6 and 7** (average: 6.0) during heating, compared to 6 after relaxation. This small variation is normal thermal fluctuation — the dopant's local environment is essentially intact. The average dopant–oxygen bond length during the simulation was **1.923 Å**.

| Metric | Value | Threshold | Result |
|--------|-------|-----------|--------|
| Coordination range | **6–7** (mean 6.0) | within ±1 of 6 | ✅ PASS |
| Avg bond length (MD) | **1.923 Å** | reference only | — |
...
*Host: NaCoO2 | Dopant: Al | Temperature: 250°C | Sites tested: 1*